...
const Overview = ({data}) => {
    ...
    return (
        <div className='p-1 sm:p-2 lg:p-6' style={{width:'90vw'}}>
            ...
            {
                show && (
                    <div className='flex flex-wrap justify-start items-center md:hidden border-2 rounded-2xl py-2 xl:py-0 px-2 md:px-6 space-y-2 md:space-y-0 space-x-1 md:space-x-0 w-fit h-fit'>
                        ...
                        <div className='border-2 xl:border-0 xl:border-r-2 md:border-r-2 rounded-lg xl:rounded-none py-2 md:py-4'>
                            <span className='subheading1 px-2 md:px-6'>Total Purpose</span>
            ...
            <div className='hidden md:flex flex-wrap justify-start items-center border-2 rounded-2xl py-2 xl:py-0 px-2 md:px-6 space-y-2 md:space-y-0 space-x-1 md:space-x-0 w-fit h-fit'>
                <div className='border-2 xl:border-0 xl:border-r-2 border-r-2 rounded-lg xl:rounded-none pl-2 py-2 md:py-4'>
                    <span className='subheading1 pr-2 md:pr-6'>Total Assessment</span>
                    <div className='flex items-center gap-4 my-4'>
                        <Image src={TA} alt='ta' />
                        <span className='numbersm md:number'>34</span>
                    </div>
                </div>
                <div className='border-2 xl:border-0 xl:border-r-2 md:border-r-2 rounded-lg xl:rounded-none py-2 md:py-4'>
                    <span className='subheading1 px-2 md:px-6'>Total Purpose</span>
